...
int numcycles = 1000;
  ...
  Servo servoArray[] = {Servo13, Servo12, Servo11, Servo10, Servo9, Servo8, Servo6, Servo5, Servo3};       // declare array of Servo objects
  ...
  Servo servoArray[] = {FDAC0, FDAC1, Servo2, Servo3, Servo4, Servo5, Servo6, Servo7, Servo8, Servo9, Servo10, Servo11, Servo12, Servo13, Servo32, Servo33, Servo34, Servo35, Servo36, Servo37, Servo38, Servo39, Servo40, Servo41, Servo42, Servo43, Servo44, Servo45, Servo46, Servo47, Servo48, Servo49, Servo50, Servo51, Servo52, Servo53};  // declare array of Servo objects
  ...
  if (Serial.available()) {
    ...
    if (c == '\n') {  
      ...
      for(int i = 0; i < len; i++){
        ...
        WriteToPin(WRITE_PIN_CONFIG[i], val, servoArray[i]);         //send value out to pin on arduino board
      }    
...
*/void WriteToDAC(int pin, int value) {
    analogWrite(pin, value); // Assuming that analogWrite is used to write to the DAC pin
}
